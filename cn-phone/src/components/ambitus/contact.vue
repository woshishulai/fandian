<template>
  <div class="container">
    ...
    <div class="conts">
      <div class="conts_top">
        <img :src="Baseurl + infolist[1].mobile_image" alt="" />
              ...
              <div class="main">
                <div class="lianxi_form">
                  ...
                  <div class="inpform">
                    <div class="inplist">
                      <p>姓名：</p>
                      <div class="inp" :class="nameshow?'active':''">
...
.inpform .inplist .inp.active{
  border: 0.133vw solid #206079;
}
