...
export default {
  ...
  created() {
    ...
    this.topimg = localStorage.getItem('homeImg')
    this.tukuId = localStorage.getItem('homeId')
    this.topname = localStorage.getItem('homeName')
    console.log(this.topimg, this.tukuId, this.topname);
    this.getlist();
  },
  methods: {
    getlist() {
